...
@php $title =  'Pattern Create | Admin Panel'; @endphp
                            ...
                            <div class="tab-pane active" id="personalDetails" role="tabpanel">
                                <form action="{{ route('admin.pattern.store') }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label for="firstnameInput" class="form-label">Pattern
                                                    Image</label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label for="skillsInput" class="form-label">size(m)</label>
                                                <select class="form-select" name="size">
                                                    <option value="">Select Size</option>
                                                    @foreach ($sizes as $size)
                                                        <option value="{{ $size->id }}"
                                                            @if (old('size') == $size->id) selected @endif>
                                                            {{ $size->size }}</option>
                                                    @endforeach
