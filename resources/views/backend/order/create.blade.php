...
@php $title =  'Orders Create | Admin Panel'; @endphp
...
@section('content')
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                value="{{ old('order_id') }}" name="order_id"
                                                        ...
                                                        <div class="col-md-4 mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ old('customer_number') }}" name="customer_number"
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                placeholder="Enter ordered date" id="nepali-datepicker">
                                                            <div class="invalid-feedback">
                                                ...
                                                <div class="card-body">
                                                            ...
                                                            <table
                                                                ...
                                                                <thead class="align-middle">
                                                                    <tr class="table-active">
                                                                        ...
                                                                        <th scope="col" style="width: 120px">Product
                                                                        </th>
                                                                    ...
                                                                    <tr class="product">
                                                                        ...
                                                                        <td>
                                                                            <input type="number" class="form-control"
                                                                                id="orders-input" placeholder="price"
                                                                        ...
                                                                        <td>
                                                                            <input type="number" class="form-control"
                                                                                ...
                                                                                step="0.01" name="quantity[]" required>
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <textarea class="form-control" id="ckeditor-classic" rows="4" name="order_notes">{{ old('order_notes') }}</textarea>
                                                        </div>
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <select class="form-select"
                                                                            ...
                                                                            name="receivable_payment_method" data-choices
                                                        ...
                                                        <div class="tab-pane" id="addproduct-metadata" role="tabpanel">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="mb-3">
                                                                        <label class="form-label"
                                                                            for="meta-keywords-input">Delivery Date</label>
                                                                        <input type="text" class="form-control"
                                                                            name="delivery_date"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Add event listener to the "Delete" buttons
            var deleteButtons = document.querySelectorAll('.btn-delete-pay');
            deleteButtons.forEach(function(button) {
                button.addEventListener('click', function() {
