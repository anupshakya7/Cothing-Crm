            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Measurements List</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Measurements</a></li>
                                <li class="breadcrumb-item active">Measurements List</li>
                            </ol>
                        </div>
                    ...
                    <div class="card" id="tasksList">
                        <div class="card-header border-0">
                            <div class="d-flex align-items-center">
                                <h5 class="card-title mb-0 flex-grow-1">All Measurements Info</h5>
                                <div class="flex-shrink-0">
                                    <div class="d-flex flex-wrap gap-2">
                                        <a href="{{ route('admin.measurement.create') }}" class="btn btn-danger add-btn"><i
                                                class="ri-add-line align-bottom me-1"></i> Create Measurement</a>
                            ...
                            <div class="table-responsive table-card mb-4">
                                <table class="table align-middle table-nowrap mb-0" id="tasksTable">
                                    <thead class="table-light text-muted">
                                        ...
                                        <form id="searchForm" action="{{ route('admin.measurement.index') }}"
                                            method="GET">
                                            <tr>
                                                <th></th>
                                                <th>
                                                    <select id="categorySearch" name="category" class="form-select">
                                                ...
                                                <th><input type="text" id="sizeSearch" name="size"
                                                        class="form-control" placeholder="Search Size"
                                                        value="{{ request('size') }}"></th>
                                                <th>
                                                    <select id="statusSearch" name="status" class="form-select">
                                                        <option value="">Search Status</option>
                                                        <option value="Active"
                                                            @if (request('status') == 'Active') selected @endif>Active
                                                        </option>
                                                        <option value="Inactive"
                                                            @if (request('status') == 'Inactive') selected @endif>Inactive
                                                        </option>
                                                    </select>
                                                </th>
                                    ...
                                    <tbody class="list form-check-all">
                                        @foreach ($measurements as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1 tasks_name">{{ $item->category }}</div>

                                                    </div>
                                                </td>
                                                <td class="project_name"><a
                                                        class="fw-medium link-primary">{{ $item->size }}</a></td>

                                                <td class="project_name"><a
                                                        class="fw-medium link-primary">{{ $item->status }}</a></td>

                                                <td class="assignedto">
                                                    <a href="{{ route('admin.measurement.edit', $item->id) }}"
                            ...
                            <div class="modal-body p-5 text-center">
                                ...
                                <div class="mt-4 text-center">
                                    ...
                                    <div class="hstack gap-2 justify-content-center remove">
                                        ...
                                        <form method="POST" action="{{ route('admin.measurement.delete', $user->id) }}"
