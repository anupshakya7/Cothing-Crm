                        ...
                        <div class="card" id="tasksList">
                            <div class="card-header border-0">
                                <div class="d-flex align-items-center">
                                    <h5 class="card-title mb-0 flex-grow-1">All User Info</h5>
                                    <div class="flex-shrink-0">
                                       <div class="d-flex flex-wrap gap-2">
                                            <a href="{{ route('admin.users.create') }}" class="btn btn-danger add-btn" ><i class="ri-add-line align-bottom me-1"></i> Create User</a>
                                    ...
                                    <table class="table align-middle table-nowrap mb-0" id="tasksTable">
                                        <thead class="table-light text-muted">
                                            <tr>
                                                ...
                                                <th class="sort" data-sort="tasks_name">Profile</th>
                                                <th class="sort" data-sort="client_name">Email</th>
                                                <th class="sort" data-sort="assignedto">Phone No</th>
                                        ...
                                        <tbody class="list form-check-all">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1 tasks_name">{{ $user->name }}</div>
                                                ...
                                                <td class="id"><a href="" class="fw-medium link-primary">{{ $user->email }}</a></td>

                                                <td class="project_name"><a href="apps-projects-overview.html" class="fw-medium link-primary">{{ $user->phone_no }}</a></td>

                                                <td class="assignedto">
                                                    <a href="{{ route('admin.users.edit', $user->id) }}" class="btn btn-outline-success">Edit</a>
                                                    <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" href="#deleteOrder{{$user->id}}">
                                                        Delete
                                                    </button>
                                                </td>
                        ...
                        <div class="modal-content">
                            <div class="modal-body p-5 text-center">
                                ...
                                <div class="mt-4 text-center">
                                    <h4>You are about to delete a hotel ?</h4>
                                    <p class="text-muted fs-14 mb-4">Deleting your hotel will remove all of
