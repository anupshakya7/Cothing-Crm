...
@php $title =  'Supplier Orders Create | Admin Panel'; @endphp
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Supplier Orders User</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.suppliers.index') }}">Supplier Orders</a>
                                </li>
                                <li class="breadcrumb-item active">Create Supplier Orders</li>
                            </ol>
                        </div>
                                            ...
                                            <div class="card">
                                                            ...
                                                            <select
                                                                ...
                                                                @foreach ($vendors as $vendor)
                                                                    <option value="{{ $vendor->id }}"
                                                                        {{ $vendor->id == old('vendor',$vendor_id) ? 'selected' : '' }}>
                                                                        {{ $vendor->name }}
                                                                    </option>
                                                                @endforeach
                                                                    ...
                                                                    <tr class="product">
                                                                        ...
                                                                        <td class="text-start">
                                                                            <div class="mb-2">
                                                                                ...
                                                                                id="choices-categorys-input" name="category[]" required>
                                                                        ...
                                                                        <td class="text-start">
                                                                            <div class="mb-2">
                                                                                ...
                                                                                @foreach ($subcategories as $category)
                                                                                    <option value="{{ $category->id }}"
                                                                                        {{ $category->id == old('subcategory') ? 'selected' : '' }}>
                                                                                        {{ $category->name }}
                                                                                    </option>
                                                                                @endforeach
                                                                        ...
                                                                        <td>
                                                                            <div class="mb-2">
                                                                                <select
                                                                                class="form-select select2 {{ $errors->has('item') ? 'is-invalid' : '' }}"
                                                                                id="choices-items-input" name="item[]" required>
                                                                                <option value="">Select Item</option>
                                                                                @foreach ($items as $item)
                                                                                    <option value="{{ $item->id }}"
                                                                                        {{ $item->id == old('item') ? 'selected' : '' }}>
                                                                                        {{ $item->name }}
                                                                                    </option>
                                                                                @endforeach
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            value="{{ old('price[]') }}" style="width:70px;" required>
                                                                        </td>
                                                                        <td>
                                                                            <input type="number" class="form-control"
                                                                ...
                                                                <tfoot>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td id="discount_amount">
                                                                            <input type="number" class="form-control" step="0.01" placeholder="discount" name="discount_amount" value="0">
                                                                        </td>
                                                                    </tr>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="hstack gap-2 justify-content-end p-3">
                                                        ...
                                                        <a href="{{request('vendor') ? route('admin.suppliers.detail',['vendor'=>request('vendor')]) : route('admin.suppliers.index') }}" type="button"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 mb-3">
                                                            <label class="form-label"
                                                                ...
                                                                <textarea class="form-control" placeholder="Enter the remarks" name="remarks" rows="3">{{ old('remarks') }}</textarea>
                                                                <div class="invalid-feedback">{{ $errors->first('remarks') }}
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12 mb-3">
                                                            <label class="form-label"
                                                                ...
                                                                <input type="text" id="nepali-date-picker"
                                                                            ...
                                                                            value="{{ old('date') }}" placeholder="Enter publish date">
                                                                <div class="invalid-feedback">{{ $errors->first('date') }}
                                                                </div>
                                                        </div>
                                                        <div class="col-md-12 mb-3">
                                                            <input type="hidden" value="0" name="hasVAT">
                                                            <input class="form-check-input" type="checkbox" value="1" name="hasVAT" id="hasVAT">
...
<script type="text/javascript">
    window.onload = function(){
        var orderDate = document.getElementById('nepali-date-picker');
        orderDate.nepaliDatePicker();
    }
</script>
<script>
    function addNewItem() {
        ...
        subcategoryOption.textContent = 'Select Sub Category';
