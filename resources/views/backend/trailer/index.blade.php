...
@php $title =  'Trailer Lists | Admin Panel'; @endphp
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Trailer List</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Trailer</a></li>
                                <li class="breadcrumb-item active">Trailer List</li>
                            </ol>
                        </div>
                    ...
                    <div class="card" id="tasksList">
                        <div class="card-header border-0">
                            <div class="d-flex align-items-center">
                                <h5 class="card-title mb-0 flex-grow-1">All Trailer Info</h5>
                                <div class="flex-shrink-0">
                                    <div class="d-flex flex-wrap gap-2">
                                        <a href="{{ route('admin.trailer.create') }}" class="btn btn-danger add-btn"><i
                                                class="ri-add-line align-bottom me-1"></i> Create Trailer</a>
                            ...
                            <div class="table-responsive table-card mb-4">
                                <table class="table align-middle table-nowrap mb-0" id="tasksTable">
                                    <thead class="table-light text-muted">
                                        ...
                                        <form id="searchForm" action="{{ route('admin.trailer.index') }}" method="GET">
                                            <tr>
                                                <th></th>
                                    ...
                                    <tbody class="list form-check-all">
                                        @foreach ($vendors as $vendor)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1 tasks_name">{{ $vendor->name }}</div>
                                                ...
                                                <td class="assignedto">
                                                    <a href="{{ route('admin.trailer.edit', $vendor->id) }}"
                            ...
                            <div class="modal-body p-5 text-center">
                                ...
                                <div class="mt-4 text-center">
                                    ...
                                    <div class="hstack gap-2 justify-content-center remove">
                                        ...
                                        <form method="POST" action="{{ route('admin.trailer.delete', $user->id) }}"
