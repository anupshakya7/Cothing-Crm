...
@php $title =  'Customers | Admin Panel'; @endphp
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label for="firstnameInput" class="form-label">Customer
                                                    Name</label>
                                                <input type="text" class="form-control" name="name" id="firstnameInput" placeholder="Enter Customer Name" value="{{old('name',$item->customer_name)}}">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label for="firstnameInput" class="form-label">Contact
                                                    Number</label>
                                                <input type="number" class="form-control" name="contact_number" id="firstnameInput" placeholder="Enter Customer Number" value="{{old('contact_number',$item->customer_contact_number)}}">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="email" class="form-control" name="email" id="firstnameInput" placeholder="Enter Customer Email" value="{{old('email',$item->email)}}">
                                                <div class="invalid-feedback">
                                                    {{$errors->first('email') }}
                                                    </div>
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="hstack gap-2 justify-content-end">
                                                ...
                                                <a href="{{ route('admin.customer.index') }}" type="button" class="btn btn-soft-success">Cancel</a>
                                            </div>
                                        </div>
                                        <!--end col-->
                                    </div>
