...
@php $title =  'Customers Create | Admin Panel'; @endphp
                    ...
                    <div class="card-body p-4">
                        <div class="tab-content">
                            <div class="tab-pane active" id="personalDetails" role="tabpanel">
                                <form action="{{ route('admin.customer.store') }}" method="POST" enctype="multipart/form-data" autocomplete="false">
                                    @csrf
                                    @method('POST')
                                      <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="email" class="form-control" name="email" id="firstnameInput" placeholder="Enter Customer Email" value="{{old('email')}}">
                                                <div class="invalid-feedback">
                                                    {{$errors->first('email') }}
                                                    </div>
                                            </div>
