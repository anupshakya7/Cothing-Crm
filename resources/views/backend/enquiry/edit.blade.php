            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Edit Enquiry</h4>
                        ...
                        <div class="card-body p-4">
                            <div class="tab-content">
                                <div class="tab-pane active" id="personalDetails" role="tabpanel">
                                    <form id="editForm" action="{{ route('admin.enquiry.update', $enquiry->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" name="contact_number"
                                                        ...
                                                        value="{{ old('contact_number', $enquiry->mobile) }}">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" name="source_type" data-choices
                                                        ...
                                                        <option value="Call"
                                                            {{ $enquiry->source_type == 'Call' ? 'selected' : '' }}>Call
                                                        </option>
                                                        <option value="Online"
                                                            {{ $enquiry->source_type == 'Online' ? 'selected' : '' }}>Online
                                                        </option>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" name="source" data-choices
                                                        ...
                                                        <option value="Facebook"
                                                            {{ $enquiry->source == 'Facebook' ? 'selected' : '' }}>Facebook
                                                        </option>
                                                        <option value="Instagram"
                                                            {{ $enquiry->source == 'Instagram' ? 'selected' : '' }}>
                                                            Instagram</option>
                                                        <option value="WhatsApp"
                                                            {{ $enquiry->source == 'WhatsApp' ? 'selected' : '' }}>WhatsApp
                                                        </option>
                                                        <option value="Viber"
                                                            {{ $enquiry->source == 'Viber' ? 'selected' : '' }}>Viber
                                                        </option>
                                                        <option value="Others"
                                                            {{ $enquiry->source == 'Others' ? 'selected' : '' }}>Others
                                                        </option>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" name="priority" data-choices
                                                        ...
                                                        <option value="High"
                                                            {{ $enquiry->priority == 'High' ? 'selected' : '' }}>High
                                                        </option>
                                                        <option value="Medium"
                                                            {{ $enquiry->priority == 'Medium' ? 'selected' : '' }}>Medium
                                                        </option>
                                                        <option value="Low"
                                                            {{ $enquiry->priority == 'Low' ? 'selected' : '' }}>Low
                                                        </option>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" name="status" data-choices
                                                        ...
                                                        <option value="Inprogress"
                                                            {{ $enquiry->status == 'Inprogress' ? 'selected' : '' }}>
                                                            Inprogress</option>
                                                        <option value="Pending"
                                                            {{ $enquiry->status == 'Pending' ? 'selected' : '' }}>Pending
                                                        </option>
                                                        <option value="Completed"
                                                            {{ $enquiry->status == 'Completed' ? 'selected' : '' }}>
                                                            Completed</option>
                                                    ...
                                                    <select class="form-select" id="handleSearch" name="handled_by"
                                                        ...
                                                        @foreach ($handle_bys as $hanlde_by)
                                                            <option value="{{ $hanlde_by->id }}"
                                                                {{ old('handled_by', $enquiry->handled_by) == $hanlde_by->id ? 'selected' : '' }}>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" name="remarks">{{ old('remaks', $enquiry->remarks) }}</textarea>
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="invoice-table table table-borderless table-nowrap mb-0">
                                                                ...
                                                                <td class="text-start">
                                                                    <div class="mb-2">
                                                                        <textarea class="form-control bg-light border-0 followup-details" name="followup_remarks[]" rows="2"
                                                                            placeholder="Followup Details">{{ $followUpDate->remarks }}</textarea>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="form-control bg-light border-0 followup-date followup-nepali-datepicker" style="width: 110%;" name="followup_date[]" placeholder="Followup date" value="{{ $followUpDate->follow_up_date }}" required />
                                                                </td>
                                                                <td class="product-removal">
                                                                    <a href="javascript:void(0)" class="btn btn-success btn-delete">Delete</a>
                                                                </td>
                                                            </tr>
                                                            @endforeach
                                                        </tbody>
                                                        <tfoot>
                                                            <tr>
                                                                <td colspan="5">
                                                                    <button type="button" id="add-item" class="btn btn-soft-secondary fw-medium"><i class="ri-add-fill me-1 align-bottom"></i> Add Item</button>
                                                                </td>
                                                            </tr>
                                                        </tfoot>
                                                    </table>
