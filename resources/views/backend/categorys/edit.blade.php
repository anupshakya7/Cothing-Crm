...
@php $title =  'Sub Category | Admin Panel'; @endphp
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.category.index',['type'=>$type]) }}">Sub Category</a></li>
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label for="firstnameInput" class="form-label">Category
                                                    Name</label>
                                                <input type="text" class="form-control" name="name" id="firstnameInput" placeholder="Enter your Full Name" value="{{ $category->name }}">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="hstack gap-2 justify-content-end">
                                                ...
                                                <a href="{{ route('admin.category.index',['type'=>$type]) }}" type="button" class="btn btn-soft-success">Cancel</a>
                                            </div>
                                        </div>
                                        <!--end col-->
                                    </div>
