                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a
                                        href="{{ route('admin.category.index', ['type' => $_REQUEST['type']]) }}">Category</a>
                                </li>
                                    ...
                                    <div class="row">
                                                ...
                                                <select class="form-select select2" name="maincategory">
                                                    ...
                                                    @foreach ($maincategorys as $main)
                                                        <option value="{{ $main->id }}"
                                                            {{ $main->id == old('maincategory',$parent_cat_id) ? 'selected' : '' }}>
                                                            {{ $main->name }}</option>
                                                    @endforeach
                                                ...
                                                <select class="form-select select2" name="category">
                                                    ...
                                                    @foreach ($categorys as $category)
                                                        <option value="{{ $category->id }}"
                                                            {{ $category->id == old('category',$catgeory_id) ? 'selected' : '' }}>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="name"
                                                    id="firstnameInput" placeholder="Enter Sub category Name"
                                                    value="{{ old('name') }}">
                                                <div class="invalid-feedback">
                                                    {{ $errors->first('name') }}
                                                </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="hstack gap-2 justify-content-end">
                                                ...
                                                <a href="{{ route('admin.category.index', ['type' => $_REQUEST['type']]) }}"
