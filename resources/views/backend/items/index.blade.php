                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Items List</h4>
                        ...
                        <div class="card" id="tasksList">
                            <div class="card-header border-0">
                                <div class="d-flex align-items-center">
                                    <h5 class="card-title mb-0 flex-grow-1">All Items Info</h5>
                                    <div class="flex-shrink-0">
                                       <div class="d-flex flex-wrap gap-2">
                                        @if(request('category'))
                                            <a href="{{ route('admin.items.create',['category'=>request('category')]) }}" class="btn btn-danger add-btn" ><i class="ri-add-line align-bottom me-1"></i> Create Item</a>
                                        @else
                                            <a href="{{ route('admin.items.create') }}" class="btn btn-danger add-btn" ><i class="ri-add-line align-bottom me-1"></i> Create Item</a>
                                        @endif    
                                    ...
                                    <table class="table align-middle table-nowrap mb-0" id="tasksTable">
                                        ...
                                        <tbody class="list form-check-all">
                                            ...
                                            <tr>
                                                ...
                                                <td class="id">
                                                    @if(!empty($item->image))
                                                        <img id="image-preview" src="{{asset('images/supplyItem/'.$item->image)}}" alt="Image Preview" style="max-width:120px;height:120px;">
                                                    @endif
                                                </td>
                                                <td>
                                                    <div class="d-flex">
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                         <div class="flex-grow-1 tasks_name">{{ $item->category ? $item->category->name : 'No Category' }}</div>
                                                    </div>
                                                </td>
                                                <td class="project_name"><a  class="fw-medium link-primary">{{ $item->status }}</a></td>

                                                <td class="assignedto">
                                                    <a href="{{ route('admin.items.edit', $item->id) }}" class="btn btn-outline-success">Edit</a>
                                                    <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" href="#deleteOrder{{$item->id}}">
                                                        Delete
                                                    </button>
                                                </td>
                            ...
                            <div class="modal-body p-5 text-center">
                                ...
                                <div class="mt-4 text-center">
                                    ...
                                    <div class="hstack gap-2 justify-content-center remove">
                                        ...
                                        <form method="POST" action="{{ route('admin.items.delete', $user->id) }}" style="display: inline">
                                            @csrf
                                            @method('DELETE')
