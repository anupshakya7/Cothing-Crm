var NepaliFunctions = (function () {
    ...
    function y() {
      return [
        "January", // जनवरी (January)
        "February", // फ़रवरी (February)
        "March", // मार्च (March)
        "April", // अप्रैल (April)
        "May", // मई (May)
        "June", // जून (June)
        "July", // जुलाई (July)
        "August", // अगस्त (August)
        "September", // सितंबर (September)
        "October", // अक्टूबर (October)
    ...
    function B(e) {
      function t(e) {
        switch (e) {
          case "0":
            return "०"; // Devanagari numeral for 0
          case "1":
            return "१"; // Devanagari numeral for 1
          case "2":
            return "२"; // Devanagari numeral for 2
          case "3":
            return "३"; // Devanagari numeral for 3
          case "4":
            return "४"; // Devanagari numeral for 4
          case "5":
            return "५"; // Devanagari numeral for 5
          case "6":
            return "६"; // Devanagari numeral for 6
          case "7":
            return "७"; // Devanagari numeral for 7
          case "8":
            return "८"; // Devanagari numeral for 8
          case "9":
            return "९"; // Devanagari numeral for 9
          default:
            return e; // Return input `e` if it's not a digit (fallback)
        }
      }
      e = e.toString();
      var n = "",
